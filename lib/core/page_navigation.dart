...
class SlideRightTransition extends CustomTransitionPage<void> {
  SlideRightTransition({super.key, required super.child})
      : super(
...
class SlideBottomTransition extends CustomTransitionPage<void> {
  SlideBottomTransition({super.key, required super.child})
      : super(
          transitionDuration: const Duration(milliseconds: 250),
          transitionsBuilder: (_, animation, __, child) {
...
class CustomSizeTransition extends CustomTransitionPage<void> {
  CustomSizeTransition({super.key, required super.child})
      : super(
          transitionDuration: const Duration(milliseconds: 250),
          transitionsBuilder: (_, animation, __, child) {
            return Align(
